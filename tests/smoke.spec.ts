...
/* La demo dell'atelier di moda (/demo/atelier-moda) è spenta a richiesta:
   la rotta non esiste più (vedi App.tsx), quindi i suoi test — che
   aprivano quella pagina — sono usciti insieme. Il componente resta nel
   repository per un'eventuale riaccensione. */
