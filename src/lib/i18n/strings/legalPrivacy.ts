      ...
      blocks: [
        ...
        { table: {
          ...
          rows: [
            ...
            ["Resend, Inc. (Stati Uniti)", "Responsabile del trattamento", "Invio dell'email di conferma a chi ha inviato una richiesta dal configuratore e del brief al Titolare, quando il canale email è configurato: riceve nome, indirizzo email e contenuto della richiesta."],
      ...
      blocks: [
        ...
        { table: {
          ...
          rows: [
            ...
            ["Resend, Inc. (United States)", "Processor", "Sending the acknowledgement email to whoever submitted an enquiry from the configurator, and the brief to the Controller, where the email channel is configured: it receives name, email address and the content of the enquiry."],
