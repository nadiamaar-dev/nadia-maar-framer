...
const TABS: { id: Tab; label: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    id: "support",
    label: "Urgenze",
    icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg>,
  },
  {
    id: "blueprint",
    label: "Blueprint",
    ...
    <div style={{ minHeight: "100vh", background: "#161B22", position: "relative" }}>
      ...
      <main style={{ position: "relative", zIndex: 2, paddingTop: 120, paddingBottom: 80 }}>
        <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 32px" }}>
          ...
          {/* Tab: Progetto */}
          {activeTab === "project"  && <ProjectTab   clientId={clientId} />}
