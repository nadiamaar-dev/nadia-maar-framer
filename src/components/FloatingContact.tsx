...
export default function FloatingContact() {
  ...
  const cardBase: React.CSSProperties = {
    ...
    border: "1px solid rgba(120,20,30,0.42)",
    boxShadow: [
      "0 0 0 1px rgba(120,20,30,0.10)",
      "0 28px 64px rgba(0,0,0,0.65)",
      "0 0 40px rgba(120,20,30,0.10)",
      ...
      <motion.button ref={btnRef}
        ...
        style={{
          ...
          boxShadow: open
            ...
            : "0 0 36px rgba(120,20,30,0.22), inset 0 1px 0 rgba(255,255,255,0.12)",
