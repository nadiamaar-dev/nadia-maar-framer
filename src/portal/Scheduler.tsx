          ...
          return (
            <button
              ...
              style={{
                ...
                background: isSelDay
                  ? "linear-gradient(140deg, rgba(224,131,106,0.34), rgba(224,131,106,0.18))"
                  : isOpen ? "rgba(255,255,255,0.09)" : "rgba(255,255,255,0.025)",
                border: `1px solid ${isSelDay ? "rgba(224,131,106,0.55)" : isOpen ? T.borderHi : T.border}`,
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: sel ? "linear-gradient(140deg, rgba(224,131,106,0.38), rgba(224,131,106,0.20))" : "rgba(255,255,255,0.035)",
                      border: `1px solid ${sel ? "rgba(224,131,106,0.60)" : T.border}`,
