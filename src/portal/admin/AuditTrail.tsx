          ...
          {logs.map(l => {
            ...
            return (
              <div key={l.id} style={{
                ...
                <span style={{ width: 28, height: 28, borderRadius: 8, flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(224,131,106,0.10)", border: "1px solid rgba(224,131,106,0.22)", color: T.copperLt }}>
