...
function ProgressBar({ value, tone }: { value: number; tone: "copper" | "green" }) {
  ...
  const fill = tone === "green"
    ...
    : "linear-gradient(90deg,#7C222B,#B83240)"
  const glow = tone === "green" ? "rgba(75,211,155,0.40)" : "rgba(184,50,64,0.45)"
    ...
    <div style={{ display: "flex", flexDirection: "column" }}>
      {sorted.map((s, i) => {
        ...
        const lineGrad = isDone
          ...
          : isActive
          ? "linear-gradient(180deg,rgba(184,50,64,0.38) 0%,rgba(255,255,255,0.07) 100%)"
            ...
            <div style={{ flex: 1, minWidth: 0, paddingBottom: last ? 0 : 20 }}>
              ...
              {(s.deliverableUrl || s.deliverableNote) && (
                <div style={{
                  ...
                  background: isActive ? "rgba(184,50,64,0.08)" : "rgba(255,255,255,0.05)",
                  border: `1px solid ${isActive ? "rgba(184,50,64,0.22)" : "rgba(255,255,255,0.09)"}`,
